...
import pilani.bosm_official_app.Events_Excel.JSONParser_day3;
...
public class day_3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_day_3,container,false);
         ...
         */
        listView = (GridView) rootView.findViewById(R.id.day3);
    ...
    class GetDataTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
             ...
             */
            JSONObject jsonObject = JSONParser_day3.getDataFromWeb();
            ...
            try {
                ...
                Log.i(JSONParser_day3.TAG, "" + je.getLocalizedMessage());
            }
            return null;
        }
    ...
    public class Keys {
        ...
        public static final String KEY_CONTACTS = "day3";
