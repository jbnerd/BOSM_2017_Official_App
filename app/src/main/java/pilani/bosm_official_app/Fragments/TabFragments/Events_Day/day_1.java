...
import pilani.bosm_official_app.Events_Excel.JSONParser_day1;
...
public class day_1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_day_1,container,false);
         ...
         */
        listView = (GridView) rootView.findViewById(R.id.day1);
    ...
    class GetDataTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
             ...
             */
            JSONObject jsonObject = JSONParser_day1.getDataFromWeb();
            ...
            try {
                ...
                Log.i(JSONParser_day1.TAG, "" + je.getLocalizedMessage());
            }
            return null;
        }
    ...
    public class Keys {
        ...
        public static final String KEY_CONTACTS = "day1";
